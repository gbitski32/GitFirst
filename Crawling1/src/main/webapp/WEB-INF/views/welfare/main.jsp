                ...
                <div class="col-lg-5 col-xl-5">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <a href="#" class="btn_2">어플소개애애애</a>
                            <div class="banner_item">
                                <div class="single_item">
                                    <img src="../resources/welfare/img/icon/banner_1.svg" alt="">
                                    <h5>Emergency Cases</h5>
                                </div>
                                <div class="single_item">
                                    <img src="../resources/welfare/img/icon/banner_2.svg" alt="">
                                    <h5>Easy Appointment</h5>
                                </div>
                                <div class="single_item">
                                    <img src="../resources/welfare/img/icon/banner_3.svg" alt="">
                        ...
                        <div class="row">
                                ...
                                <div class="single_feature">
                                    <div class="single_feature_part">
                                        <span class="single_feature_icon">
                                        	<img src="../resources/welfare/img/icon/feature_1.svg"alt="">
                                        </span>
                                        <h4>Better Future</h4>
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_feature">
                                    <div class="single_feature_part">
                                        <span class="single_feature_icon">
                                        	<img src="../resources/welfare/img/icon/feature_2.svg" alt="">
                                        </span>
                                        <h4>Better Future</h4>
                                        <p>Darkness multiply rule Which from without life creature blessed
                                            give moveth moveth seas make day which divided our have.</p>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-md-6 col-lg-6">
                    <div class="our_ability_img">
                        <img src="../resources/welfare/img/ability_img.png" alt="">
                    </div>
                </div>
    ...
    <section class="top_service our_ability padding_bottom">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="our_ability_img">
                        <img src="../resources/welfare/img/top_service.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-10">
                    <div class="client_review_part owl-carousel">
                        <div class="client_review_single">
                            <img src="../resources/welfare/img/Quote.png" class="Quote" alt="quote">
            ...
            <div class="row align-items-center regervation_content">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="reservation_img">
                        <img src="../resources/welfare/img/reservation.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="../resources/welfare/img/doctor/doctor_1.png" alt="doctor">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="../resources/welfare/img/doctor/doctor_4.png" alt="doctor">
                            <div class="social_icon">
                                <a href="#"> <i class="ti-facebook"></i> </a>
                                <a href="#"> <i class="ti-twitter-alt"></i> </a>
                                <a href="#"> <i class="ti-instagram"></i> </a>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="../resources/welfare/img/doctor/doctor_2.png" alt="doctor">
                            <div class="social_icon">
                                <a href="#"> <i class="ti-facebook"></i> </a>
                                <a href="#"> <i class="ti-twitter-alt"></i> </a>
                                <a href="#"> <i class="ti-instagram"></i> </a>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="single_blog_item">
                        <div class="single_blog_img">
                            <img src="../resources/welfare/img/doctor/doctor_3.png" alt="doctor">
                            <div class="social_icon">
                                <a href="#"> <i class="ti-facebook"></i> </a>
                                <a href="#"> <i class="ti-twitter-alt"></i> </a>
                                <a href="#"> <i class="ti-instagram"></i> </a>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="../resources/welfare/img/blog/blog_1.png" class="card-img-top" alt="blog">
                            <div class="card-body">
                                <ul>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="../resources/welfare/img/blog/blog_2.png" class="card-img-top" alt="blog">
                            <div class="card-body">
                                <ul>
                                    <li> <span class="ti-user"></span>Jhon mike</li>
                                    <li> <span class="ti-bookmark"></span>Clinic, doctors</li>
                ...
                <div class="col-sm-6 col-lg-4 col-xl-4">
                    <div class="single-home-blog">
                        <div class="card">
                            <img src="../resources/welfare/img/blog/blog_3.png" class="card-img-top" alt="blog">
                            <div class="card-body">
                                <ul>
                                    <li> <span class="ti-user"></span>Jhon mike</li>
                                    <li> <span class="ti-bookmark"></span>Clinic, doctors</li>
